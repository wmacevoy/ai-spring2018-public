 ...
 * https://algs4.cs.princeton.edu/33balanced/tinyST.txt
 *
 * A symbol table implemented using a left-leaning red-black BST. This is the
 * 2-3 version.
 *
 * Note: commented out assertions because DrJava now enables assertions by
 * default.
 *
 ...
 * Warren MacEvoy
 * 
 * modified to remove depenence on non-standard Queue, and to allow for access
 * to keys in O(log n) for removal from cache, and a fast method to clear() 
 * (erase) the structure.
 * 
 */
...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    **************************************************************************
    ...
    // added to remove random key, should be in order
